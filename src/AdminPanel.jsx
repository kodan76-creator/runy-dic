          ...
          <div className="form-section">
            ...
            <form onSubmit={handleSubmit} className="word-form">
              ...
              <div className="form-column form-column-right">
                ...
                <input type="text" className="runic-input" placeholder="Пример (на рунном языке)" value={formData.example2} onChange={e => setFormData({ ...formData, example2: e.target.value })} />
